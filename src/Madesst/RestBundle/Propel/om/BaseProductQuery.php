 ...
 * @method ProductQuery orderByUpdated($order = Criteria::ASC) Order by the updated column
 ...
 * @method ProductQuery groupByUpdated() Group by the updated column
 ...
 * @method Product findOneByUpdated(string $updated) Return the first Product filtered by the updated column
 ...
 * @method array findByUpdated(string $updated) Return Product objects filtered by the updated column
...
abstract class BaseProductQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Madesst\\RestBundle\\Propel\\Product', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT ID, CREATED_AT, UPDATED, NAME, DESCRIPTION, PRICE FROM product WHERE ID = :p0';
        try {
    ...
    public function filterByUpdated($updated = null, $comparison = null)
    {
        if (is_array($updated)) {
            ...
            if (isset($updated['min'])) {
                $this->addUsingAlias(ProductPeer::UPDATED, $updated['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updated['max'])) {
                $this->addUsingAlias(ProductPeer::UPDATED, $updated['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProductPeer::UPDATED, $updated, $comparison);
    }
