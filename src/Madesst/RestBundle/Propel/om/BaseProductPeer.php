...
namespace Madesst\RestBundle\Propel\om;
...
use Madesst\RestBundle\Propel\ProductPeer;
use Madesst\RestBundle\Propel\map\ProductTableMap;
...
abstract class BaseProductPeer
{
    ...
    const OM_CLASS = 'Madesst\\RestBundle\\Propel\\Product';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'CreatedAt', 'Updated', 'Name', 'Description', 'Price', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdAt', 'updated', 'name', 'description', 'price', ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID, ProductPeer::CREATED_AT, ProductPeer::UPDATED, ProductPeer::NAME, ProductPeer::DESCRIPTION, ProductPeer::PRICE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CREATED_AT', 'UPDATED', 'NAME', 'DESCRIPTION', 'PRICE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'created_at', 'updated', 'name', 'description', 'price', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CreatedAt' => 1, 'Updated' => 2, 'Name' => 3, 'Description' => 4, 'Price' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdAt' => 1, 'updated' => 2, 'name' => 3, 'description' => 4, 'price' => 5, ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID => 0, ProductPeer::CREATED_AT => 1, ProductPeer::UPDATED => 2, ProductPeer::NAME => 3, ProductPeer::DESCRIPTION => 4, ProductPeer::PRICE => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CREATED_AT' => 1, 'UPDATED' => 2, 'NAME' => 3, 'DESCRIPTION' => 4, 'PRICE' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'created_at' => 1, 'updated' => 2, 'name' => 3, 'description' => 4, 'price' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProductPeer::UPDATED);
